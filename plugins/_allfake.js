		...
		global.adReply = {
			contextInfo: {
				...
				externalAdReply: { // Bagian ini sesuka kalian berkreasi :'v
					...
					sourceUrl: "https://youtube.com/@ohmyriiss28 ko"			
				}
			}
		}
                global.flocation = {
...
global.fakefb = {
         contextInfo: { externalAdReply: { showAdAttribution: true,
            mediaUrl: "https://instagram.com/ohmyriiss28",
            mediaType: "VIDEO",
            description: "https://instagram.com/ohmyriiss28", 
            title: wm3,
            body: wm,
            thumbnailUrl: pp,
            sourceUrl: sgc
        ...
        global.fvn = {
            ...
            message: { "liveLocationMessage": { "caption":"by : 아리스 푸르완토","h": `${wm}`, 'jpegThumbnail': fs.readFileSync('./thumbnail.jpg')}}
           }
            ...
            participant: `0@s.whatsapp.net`, ...(m.chat ? 
            { remoteJid: "status@broadcast" } : {}) },
            message: { "liveLocationMessage": { "title": "아리스 푸르완토","h": wm, 'jpegThumbnail': fs.readFileSync('./thumbnail.jpg')}}
           }
               ...
               message: {
                   "productMessage": {
                       "product": {
                           ...
                           "title": "•⊰❂ OMR28-BOT ❂⊱•" , //Terserah Di Isi apa
                           "description": "아리스 푸르완토", 
                           "currencyCode": "USD",
